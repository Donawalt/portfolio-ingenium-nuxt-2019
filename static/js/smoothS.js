   ...
   */
  {
    ...
    class Item {
      constructor(el) {
        ...
        this.DOM.image = this.DOM.el.querySelector('.picture__item');
        ...
        this.DOM.title = this.DOM.el.querySelector('.project__item .title');
    ...
    class SmoothScroll {
      constructor() {
        ...
        [...this.DOM.content.querySelectorAll('.project__item')].forEach(item => this.items.push(new Item(item)));
